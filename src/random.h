...
static unsigned random_number_seed[ 113 ];
...
extern "C"
{
    ...
    extern int RanInit(         // Output +ve seed used, either from input or
                          // time
                          Rand_t Rand,  // Output generator state 
                          int seed);    // Input seed: +ve = value, -ve = time 
                                        // 
    // 
    // seed
    ...
    extern unsigned Rangrid(    // Output random sample, from [0, bound-1]
                               Rand_t Rand,     // Update generator state
                               unsigned bound); // Input supremum (0 means
    // 2^32)

    extern float Ranfloat(      // Output single-precision sample inside (0.0, 
                                // 
                             // 
                             // 1.0)
                             Rand_t Rand);      // Update generator state
    ...
    extern double Rangauss(     // Output random sample from normal
                              // distribution
                              Rand_t Rand);     // Update generator state

    extern double Rancauchy(    // Output random sample from Cauchy
                               // distribution
                               Rand_t Rand);    // Update generator state

    extern double Rangamma(     // Output random sample from gamma
                              // distribution
                              Rand_t Rand,      // Update generator state
                              double c);        // Exponent of gamma
    // distribution

    extern unsigned Ranpoiss(   // Output random sample from Poisson
                                // distribution
                                Rand_t Rand,    // Update generator state
                                double c);      // Mean of Poisson
    // distribution 

    extern unsigned Ranbinom(   // Output random sample from binomial
                                // distribution
                                Rand_t Rand,    // Update generator state
    ...
    extern double Ranbeta(      // Output random sample from beta distribution
                             Rand_t Rand,       // Update generator state
                             int r,     // Number of successes in beta
                             // distribution 
                             int n);    // Total number in beta distribution

    extern unsigned Rangeom(    // Output random sample from truncated
                               // geometric
                               Rand_t Rand,     // Update generator state
                               double alpha,    // Defines ratio
                               // alpha/(alpha+1) < 1
    ...
    extern double Ran1posneg(   // Output sample in (-inf,inf) from
                                // bi-Gaussian
                                Rand_t Rand,    // Update generator state
                                double f,       // Input coefficient of x
                                double u,       // Input coefficient of |x|,
                                // >= 0
                                double A);      // Input Gaussian curvature

    extern void Ran2posneg(     // Output sample in (-inf,inf)^2 from
                              // bi-Gaussian^2
                              Rand_t Rand,      // Update generator state
                              double f, // Input coefficient of x
                              ...
                              // <= A11*A22
                              double A22,       // Input yy curvature >= 0
                              double *x,        // Output x sample position in 
                                                // 
                              // 
                              // (0,inf)
                              double *y);       // Output x sample position in 
                                                // 
    // 
    // (0,inf)

    extern double RanPos1(      // Output sample in [0,inf) from
                             // spike+Gaussian
                             Rand_t Rand,       // Update generator state
    ...
    extern double InvNorm(      // Output inverse normal = # of standard
                             // deviations
