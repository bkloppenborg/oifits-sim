...
Detector::Detector( int nspectral , int nreads , int ntimesteps , int nwavesteps , double read_noise , double quantum_efficiency, double dark_current , double ADC_gain )
{
