...
class Detector
{
  public:
    ...
    void OneReadP(double current_time, Combiner * combiner, SpectralMode * Wav,
                  Source * Source);
    void FastOneReadP(double current_time, Combiner * combiner,
                      SpectralMode * Wav, Source * Source);
