...
\index{Row@{Row}!ncols@{ncols}}
\index{ncols@{ncols}!Row@{Row}}
\subsubsection[{ncols}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T$>$ int {\bf Row}$<$ T $>$::{\bf ncols}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
...
\index{Row@{Row}!row@{row}}
\index{row@{row}!Row@{Row}}
\subsubsection[{row}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T$>$ T$\ast$ {\bf Row}$<$ T $>$::{\bf row}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
